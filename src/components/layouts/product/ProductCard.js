...
const ProductCard = ({ info, apigetproductList }) => {
  ...
  return (
    <div // onClick={()=>navigate(`/product/${info.id}`)}
    className="ProductCard">
      <div className="max-w-lg rounded overflow-hidden shadow-lg">
        <img
          className="w-full h-[240px]  object-contain"
          src={`http://api.easivisit.com${info.covermageName}`}
                ...
                : info.type === 3
                  ...
                  : info.type === 4
                    ...
                    : info.type === 5
                      ...
                      : info.type === 6
                        ? " ایزی بانک پیشفرض"
                        : info.type === 7 ? "ایزی بانک اختصاصی" : null}
          </span>
        </div>
        <div className="grid grid-cols-2 gap-[10px] p-[10px]">
          <Popconfirm
            ...
            cancelText="No"
          >
            <Button varient="primary">پاک کردن محصول</Button>
          </Popconfirm>
          <Button
            varient="secondary"
            onClick={() => navigate(`/Editproduct/${info.id}`)}
          >
            ویرایش محصول
          </Button>
        </div>
